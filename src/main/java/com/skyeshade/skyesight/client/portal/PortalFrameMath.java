...
public final class PortalFrameMath {
    private static final double CLIP_PLANE_OFFSET = 0.001D;

    private PortalFrameMath() {}

    public static PortalViewPlacement placeCamera(
            Camera mainCamera,
            PortalFrame entrancePortal,
            PortalFrame exitPortal
    ) {
        return placeCameraCommitted(mainCamera.getPosition(), entrancePortal, exitPortal);
    }
    ...
    public static PortalViewPlacement placeCamera(
        ...
        return placeCameraCommitted(sourcePosition, entrancePortal, exitPortal);
    }

    private static PortalViewPlacement placeCameraCommitted(
            Vec3 sourcePosition,
            PortalFrame entrancePortal,
            PortalFrame exitPortal
    ) {
        ...
        return new PortalViewPlacement(
    ...
    public static Quaternionf portalRenderRotation(PortalFrame portal) {
